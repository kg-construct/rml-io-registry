...
**Title**: SQLServer: Table with datatypes: string and integer
...
**Input**
 [http://w3id.org/rml/resources/rml-io/RMLIOREGTC0006v/resource.sql](http://w3id.org/rml/resources/rml-io/RMLIOREGTC0006v/resource.sql)

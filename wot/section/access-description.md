...
Note: `mqv` prefix is an example, no ontology exist yet for Kafka data streams, but can be created using [WoT Binding Templates](https://www.w3.org/TR/wot-binding-templates/).
...
Note: `kafka` prefix is an example, no ontology exist yet for Kafka data streams, but can be created using [WoT Binding Templates](https://www.w3.org/TR/wot-binding-templates/).
